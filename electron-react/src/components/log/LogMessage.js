...
function LogMessage(props){
    const symbol = props.type==="warning"?warning_svg:(props.type==="error"?error_svg:success_svg);
    return(
        <div className='LogMessage'><img src = {symbol} alt="LogMessage" /> {" " + props.message} </div>
      );
